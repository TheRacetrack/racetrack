...
metric_images_built = Counter(
    "images_built",
    "Number of Fatman images built successfully",
)
metric_images_building_errors = Counter(
    "images_buidling_errors",
    "Number of failures when building Fatman images",
)
metric_image_building_requests = Counter(
    "image_building_requests",
    "Number of Fatman images requested for building",
    labelnames=['fatman_name', 'fatman_version'],
)
