...
def test_deploy_model():
    ...
    _install_plugin('github.com/LookACastle/plugin-python-job-type==2.5.8')
    if environment == 'docker':
        _install_plugin('github.com/LookACastle/plugin-docker-infrastructure==1.1.0')
    elif environment == 'kind':
        _install_plugin('github.com/LookACastle/plugin-kubernetes-infrastructure==1.1.0')
