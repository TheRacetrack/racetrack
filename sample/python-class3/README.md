...
# Calling a Job
The model multiplies numbers together.
The following request performs its functionality:
```bash
curl -X POST "http://127.0.0.1:7105/pub/job/multiplier/latest/api/v1/perform" \
...
# API docs
Check out root endpoint [http://127.0.0.1:7105/pub/job/multiplier/latest](http://127.0.0.1:7105/pub/job/multiplier/latest)
