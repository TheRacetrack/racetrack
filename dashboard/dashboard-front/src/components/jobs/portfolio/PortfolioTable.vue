...
const columns: QTableProps['columns'] = [
    ...
    },
    {
        ...
        align: 'right',
        field: (row: PortfolioJob) => row.update_time_days_ago,
        format: (val: number) => formatDecimalNumber(val),
        sortable: true,
    },
    {
        ...
        align: 'right',
        field: (row: PortfolioJob) => row.last_call_time_days_ago,
        format: (val: number) => formatDecimalNumber(val),
        sortable: true,
    },
    {
    ...
    },
    {
        ...
        label: 'Purge score',
        align: 'right',
        field: (row: PortfolioJob) => row.purge_score,
        format: (val: number) => formatDecimalNumber(val),
        sortable: true,
    },
    {
    ...
    },
    {
        ...
        label: 'Creation time',
        align: 'left',
        field: (row: PortfolioJob) => row.create_time,
        format: (val: number) => formatTimestampIso8601(val),
        sortable: true,
    },
    {
