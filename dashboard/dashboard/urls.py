...
urlpatterns = [
    ...
    path('api/delete-job/<job.name>/<job.version>', views.delete_job, name='delete_job'),
    path('api/redeploy-job/<job.name>/<job.version>', views.redeploy_job, name='redeploy_job'),
    path('api/reprovision-job/<job.name>/<job.version>', views.reprovision_job, name='reprovision_job'),
    path('job/logs/<job.name>/<job.version>', views.job_runtime_logs, name='job_runtime_logs'),
    path('job/build-logs/<job.name>/<job.version>', views.job_build_logs, name='job_build_logs'),
